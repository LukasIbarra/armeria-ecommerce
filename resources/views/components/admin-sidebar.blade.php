...
<aside id="sidebar" class="flex flex-col w-64 bg-[#1b3329] text-gray-100 fixed inset-y-0 left-0 z-50 transform transition-transform duration-300 ease-in-out md:relative md:translate-x-0 -translate-x-full">
  ...
  <nav class="flex-1 px-3 py-6 space-y-1">
    ...
    <x-sidebar-disabled icon="fa-solid fa-tags" label="Categorías (Próximamente)" />
